...
import com.projectmanagement.api.SpringApplicationContext;
import com.projectmanagement.api.dto.UserDto;
import com.projectmanagement.api.requests.UserLoginRequest;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        res.addHeader("user_id", userDto.getUid());
        res.getWriter().write("{\"token\": \"" + token + "\", \"id\": \""+ userDto.getUid() + "\" }");
